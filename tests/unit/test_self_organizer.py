...
class FuzzySelfOrganizerTest(testing.TestCase):
    ...
    def test_min_dist_vector(self, problem_type):
        ...
        target_distance = {
            ...
            'regression':
                numpy.array([
                    [1.36468951, 1.36468950, 1.36468951],
                    [1.29974200, 1.29974200, 1.57181756],
                    [1.67932210, 1.67932210, 1.67932210],
                    [1.62267612, 1.78237179, 1.78237170],
                    [1.65376513, 1.65376514, 1.65376514]
                ])
        }
    ...
    def test_new_neuron_weights(self, problem_type):
        ...
        new_weights = {
            ...
            'regression': {
                'ck': [0.495998019, 0.46910115, 0.47057344, 0.536142225, 0.498671019],
                'sk': [1.571221960, 1.62615874, 1.63931250, 1.581606896, 1.578999649]
            },
        }
